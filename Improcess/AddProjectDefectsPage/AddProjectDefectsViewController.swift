...
{
  func displaySomething(viewModel: AddProjectDefects.Something.ViewModel)
}

class AddProjectDefectsViewController: UIViewController, AddProjectDefectsDisplayLogic
{
  ...
  func doSomething()
  {
    let request = AddProjectDefects.Something.Request()
